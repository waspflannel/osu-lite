...
namespace osu.Game.Online
{
    public static class MessageFormatter
    {
        ...
        /// <summary>
        /// The root URL for the website, used for link matching.
        /// </summary>
                                          ...
                                          char[]? escapeChars = null)
        {
            ...
            {
                Logger.Log($"Failed to parse text ({e.Message}). Content follows:");
        ...
        private static MessageFormatterResult format(string toFormat, int startIndex = 0)
        {
